...
export const Topbar: React.FC<TopbarProps> = ({ onOpenMobileSidebar, collapsed }) => {
  ...
  return (
    <header
      className={`sticky top-0 z-30 h-16 bg-[#0B1130]/80 border-b border-slate-800/80 backdrop-blur-xl transition-all duration-300 ${
        ...
        <div className="flex items-center gap-3 sm:gap-4 ml-auto">
          ...
          <div className="relative hidden md:flex items-center w-64 lg:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-1.5 rounded-xl bg-slate-900/80 border border-slate-800 text-slate-200 placeholder-slate-500 text-xs focus:outline-none focus:border-[#3D5AFE] transition-all"
            />
          </div>
