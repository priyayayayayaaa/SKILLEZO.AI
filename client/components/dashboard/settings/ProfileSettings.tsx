...
export const ProfileSettings: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSave} className="p-6 rounded-3xl bg-slate-900/50 border border-slate-800/80 backdrop-blur-md space-y-6">
      <CardHeader
      ...
      <div className="space-y-4 max-w-xl">
        ...
        <button
          type="submit"
          className="px-5 py-2.5 rounded-xl bg-[#3D5AFE] hover:bg-[#3D5AFE]/90 text-white text-xs font-semibold shadow-md shadow-[#3D5AFE]/20 transition-all"
        >
