  ...
  return (
    <div className="p-6 rounded-3xl bg-slate-900/50 border border-slate-800/80 backdrop-blur-md space-y-4">
      ...
      <div className="space-y-4">
        <div>
          <span className="text-xs text-slate-400 block mb-1">Biography</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          <div className="p-3 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-1">
            <span className="text-slate-400 flex items-center gap-1.5">
              <Briefcase className="w-3.5 h-3.5 text-slate-500" />
              Target Role
            </span>
            <p className="font-bold text-slate-200">{profile.role}</p>
          </div>
          ...
          <div className="p-3 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-1">
            ...
            <p className="font-bold text-slate-200">{profile.location}</p>
          </div>
          ...
          <div className="p-3 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-1">
            ...
            <p className="font-bold text-slate-200">{profile.email}</p>
          </div>
          ...
          <div className="p-3 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-1">
            ...
            <p className="font-bold text-slate-200">{profile.phone || 'N/A'}</p>
          </div>
        </div>
      </div>
    </div>
