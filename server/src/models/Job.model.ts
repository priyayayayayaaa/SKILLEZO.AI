...
import { JobEmploymentType, WorkplaceType, JobStatus, CompetencyImportance } from "../constants/enums";
...
const requiredSkillSchema = new Schema<IJobRequiredSkill>(
  {
    ...
    minYearsOfExperience: { type: Number, default: 0, min: 0 },
  },
  { _id: false }
);
...
const jobSchema = new Schema<IJob>(
  {
    ...
    minExperienceYears: { type: Number, required: true, default: 0, min: 0 },
